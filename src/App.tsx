  ...
  return (
    <div className="min-h-screen font-sans selection:bg-romantic-300">
      ...
      <section className="relative h-screen flex flex-col items-center justify-center text-center px-4 overflow-hidden">
        ...
        >
          ...
          <h1 className="serif text-5xl md:text-8xl font-bold text-gray-900 mb-4 tracking-tight">
            Happy Birthday, <br />
            <span className="text-romantic-500 italic">Rhema</span>
          </h1>
          <p className="text-lg md:text-xl text-gray-600 max-w-2xl mx-auto font-light leading-relaxed">
            A heartfelt gift for my princess who makes every moment feel better. I hope you get to feel the joy you make others feel.
          </p>
        </motion.div>
      ...
      <section className="py-24 bg-romantic-100/30 relative z-10 border-t border-romantic-100">
        <div className="max-w-3xl mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600">A space for heartfelt replies, just for you, Rhema.</p>
          </div>
            ...
            <div className="p-4 bg-white/50 border-t border-romantic-100">
              <div className="flex gap-2">
                <input
                  ...
                  placeholder="What's on your heart, Rhema?"
      ...
      <footer className="py-12 bg-white text-center border-t border-romantic-100 relative z-10">
        <p className="serif italic text-gray-400">Made with a heart full of love for Rhema.</p>
